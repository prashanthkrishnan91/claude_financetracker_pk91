...
- Product/design reviewers for premium UX
...
- Generic agents do not know repo-specific invariants (deterministic decision authority, Data Truth, SQL/runtime cert).
