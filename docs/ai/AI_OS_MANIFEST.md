# AI OS Manifest — Finance Tracker
...
- Finance-specific reviewers: `policy-authority-reviewer`, `data-truth-reviewer`, `sql-runtime-reviewer`, `plain-english-ui-reviewer`

## Required command aliases

- `/test-selector`
- `/contract-audit`
- `/runtime-gate` (or `/latency-gate`)
- `/claim-safety-gate`
- `/pre-pr-self-audit`
- `/pr-summary`
- `/update-handoff`
