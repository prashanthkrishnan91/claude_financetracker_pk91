...
2. Run latency/runtime gate if provider, LLM, db, worker, snapshot, or route behavior changed.
3. Run claim/data-safety gate if user-visible text/data/actions/evidence changed.
