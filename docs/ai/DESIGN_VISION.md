...
Each implementation phase must use the relevant focused skill in `.claude/skills/`, the Plain-English UI Pack and matching UI build archetype in `docs/ai/SAFETY_PACKS_AND_ARCHETYPES.md`, and the UI budget gate in `docs/ai/PROMPT_LIBRARY.md`.
