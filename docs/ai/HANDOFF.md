...
Last updated: 2026-06-11 (Stage 9O closeout — Vanguard issuer-official rejected after live 404s; issuer eligibility guard added; ETF provider matrix updated; product-spine pivot recorded).

**Stage 9O closeout (current PR):** Vanguard issuer-official holdings diagnostic — closed out after live runtime diagnostic confirmed 404 for all tested URLs. ETF provider matrix updated to `rejected_insufficient`. No Stage 9P Vanguard adapter.
