...
Last updated: 2026-07-10 (Stage 13A patch — fix evidence-band vocabulary in the evidence-aware Paycheck Plan stock gate to match production Intel v3 card serialization; backend-only; no UI, SQL, provider, or LLM changes).
