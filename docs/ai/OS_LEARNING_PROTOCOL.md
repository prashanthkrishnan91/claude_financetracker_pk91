# OS Learning Protocol — Finance Tracker
...
- LLM/agent authority creep over visible Buy/Hold/Trim/Sell decisions
- Data Truth mapping misses (suppression vs fabrication)
- raw metric/diagnostic UI leakage (raw keys, posture/shadow labels, jargon)
