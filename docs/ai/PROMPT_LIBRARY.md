...
<stop_condition>
Do not flip visibility. Do not change snapshot/contract shape.
</stop_condition>
```
...
<acceptance_evidence>
[Specific test previously failing now passes. No regression.]
</acceptance_evidence>
...
<safety_packs>
Plain-English UI Pack, No Visible Behavior Change Pack, Test Tier Pack.
</safety_packs>
...
<acceptance_evidence>
[Screenshot diff. No backend/API/business-logic change.]
</acceptance_evidence>
...
<acceptance_evidence>
Docs read cleanly; HANDOFF.md updated by replacing/summarizing (not appending).
</acceptance_evidence>
