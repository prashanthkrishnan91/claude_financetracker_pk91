...
| 2026-05-15 | #330 | p01 | initial | n/a | workflow/scripts,docs,ci | unknown | claude-haiku-4-5-20251001 | new-chat | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable | none | strict ledger-row enforcement (Level 1+ must always commit row); self-tests; workflow/doc updates; enforce "unavailable" scope | 1 | remove explicit ref for pull_request events in GitHub Actions — let actions/checkout handle ref correctly |
