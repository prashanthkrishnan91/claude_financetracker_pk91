...
- **Stage 2.6A** — Deploy v3 powers Step 1/2/3 flow — Step 1/2/3 is primary UX; Deploy v3 is Step 2 data source (has_moves/no_moves/setup_incomplete/not_available states); diagnostic panels collapsed into "Setup & diagnostics" details section; `deploy-v3-step2-mapper.ts` pure mapper; 36 new contract tests; 256 total; build green. No backend changes, no SQL.
