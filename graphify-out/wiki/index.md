...
- **In-degree**: 0
- **Imports**: _none_
- **Functions/methods**: `repo_root`, `collect_py_files`, `module_name`, `parse_imports`, `count_lines`, `extract_functions`, `build_graph`, `find_communities`, `god_node_threshold`, `write_graph_report`
...
- **LoC**: 9
- **In-degree**: 0
- **Imports**: `deposit`, `portfolio`, `position`, `price`, `recommendation`, `transaction`, `user`
- **Functions/methods**: _none_
...
- **LoC**: 55
- **In-degree**: 0
- **Imports**: `config`, `middleware.auth`, `services.ai_service`, `services.price_engine`
...
- **LoC**: 158
- **In-degree**: 0
- **Imports**: `database`, `middleware.auth`, `models.user`, `services.crypto_service`
...
- **LoC**: 64
- **In-degree**: 0
- **Imports**: `middleware.auth`, `models.deposit`, `services.deposit_service`
...
- **LoC**: 52
- **In-degree**: 0
- **Imports**: `config`, `middleware.auth`, `models.drip`, `services.drip_service`, `services.price_engine`
...
- **LoC**: 179
- **In-degree**: 0
- **Imports**: `database`, `middleware.auth`, `models.portfolio`, `services.portfolio_service`
...
- **LoC**: 214
- **In-degree**: 0
- **Imports**: `config`, `database`, `middleware.auth`, `models.position`, `services.migration_service`, `services.price_engine`
...
- **LoC**: 216
- **In-degree**: 0
- **Imports**: `config`, `database`, `middleware.auth`, `models.price`, `services.crypto_service`, `services.history_service`, `services.price_engine`
...
- **LoC**: 148
- **In-degree**: 0
- **Imports**: `config`, `middleware.auth`, `models.recommendation`, `services.agents.job_runner`, `services.price_engine`, `services.recommendation_engine`
...
- **LoC**: 281
- **In-degree**: 0
- **Imports**: `config`, `database`, `middleware.auth`, `models.transaction`, `prices`, `services.crypto_service`, `services.import_service`, `services.plaid_service`, `services.price_engine`
...
- **LoC**: 74
- **In-degree**: 0
- **Imports**: `data_sources`, `llm`, `state`
...
- **LoC**: 98
- **In-degree**: 0
- **Imports**: `config`, `crypto_service`, `database`, `orchestrator`, `price_engine`
...
- **LoC**: 403
- **In-degree**: 0
- **Imports**: `data_sources`, `database`, `fundamental_agent`, `llm`, `portfolio_manager`, `sentiment_agent`, `state`, `technical_agent`
...
- **LoC**: 339
- **In-degree**: 0
- **Imports**: `config`, `crypto_service`, `database`
...
- **LoC**: 171
- **In-degree**: 0
- **Imports**: `database`, `models.deposit`
...
- **LoC**: 253
- **In-degree**: 0
- **Imports**: `database`, `models.drip`, `recommendation_engine`
...
- **LoC**: 659
- **In-degree**: 0
- **Imports**: `config`, `database`, `models.portfolio`, `services.price_engine`
...
- **LoC**: 575
- **In-degree**: 0
- **Imports**: `agents.job_runner`, `database`, `models.recommendation`
