...
RESEARCH_RATIONALE: dict[str, str] = {
    # ── Core ETFs ──────────────────────────────────────────────────────────────
    "VOO":   "S&P 500 core; soft landing intact (GDP +2.4%) but tariff headwinds create chop — time in market beats timing, DCA every deposit.",
    "QQQ":   "Nasdaq-100 +20% Q1 YTD; AI monetization (Copilot, Agentforce, Advantage+) flowing into earnings — DCA every deposit.",
    "VYM":   "Fed at 3.5–3.75% with rate descent beginning; dividend compounders gain relative appeal vs growth — never interrupt DRIP.",
    "SCHD":  "3.5%+ dividend yield with consistent dividend-growth track record; sector rotation favoring income — hold forever, DRIP on.",
    "VTI":   "Total US market; broadest diversification possible — DCA always, complements VOO core.",
    "GLD":   "Gold at $4,672/oz — JP Morgan targets $5,055 Q4; Iran conflict, tariff uncertainty, central bank buying (585T/qtr) all intact.",
    "VGT":   "Tech sector ETF; highest-quality AI-exposed names without single-stock concentration — hold alongside QQQ.",
    "XLE":   "Iran conflict pushed oil +40%; energy margin tailwind but demand destruction risk if prolonged — hold, trailing stop near $82.",
    "VHT":   "Healthcare defensive with aging demographics structural tailwind; defensive rotation benefiting sector — hold.",
    "VIS":   "Industrials ETF; US reshoring/onshoring manufacturing theme intact despite tariff headwinds — hold.",
    "VXUS":  "Dollar weakness from tariff uncertainty could lift international positions; hold as diversifier.",
    "SPY":   "Pending ETF swap to VOO (identical exposure, lower 0.03% ER vs 0.09%) once LT eligible May 2026.",
    "VUG":   "Pending ETF swap to QQQ (growth concentration, active rebalancing) once LT eligible July 2026.",
    # ── Core Stocks ────────────────────────────────────────────────────────────
    "NVDA":  "$500B+ Blackwell/Vera Rubin backlog; 92% GPU market share; 8-month price consolidation compressing premium as EPS grows into it — continue DCA.",
    "META":  "27% off ATH despite Advantage+ at $60B run rate and $838 avg analyst target — Q1 earnings April 29 is the re-rating catalyst; accumulate now.",
    "GOOGL": "Cheapest Mag-7 at 29x forward; Gemini 750M users; Cloud scaling; antitrust worst-case (Chrome sale) rejected — accumulate into weakness.",
    "AAPL":  "Q1 FY26 record $143.8B revenue (+16% YoY); iPhone 17 + Siri 2.0 at WWDC June 8 are the next catalysts — hold, light adds ahead of June.",
    "MSFT":  "22x forward P/E with Azure +39% YoY and Copilot at 15M seats (+160% YoY) — most oversold quality compounder in Mag-7, Q3 earnings April 29.",
    "TSM":   "2nm ramp driving 31%+ FY revenue growth; geopolitical risk at multi-year high — hold ahead of April 10 earnings, don't over-concentrate.",
    "NFLX":  "325M subscribers; ad revenue guided to roughly double in 2026; April 16 Q1 earnings is the near-term catalyst — hold.",
    "CRM":   "Agentforce $800M ARR in every top-10 enterprise deal; 37% analyst upside at current price — best value in AI software, accumulate.",
    "COST":  "Membership fee income +13.6% YoY; gas station margins rising on Iran-driven oil spike — recession-resistant and counterintuitively benefiting.",
    "QCOM":  "Snapdragon AI PC chip cycle + automotive diversification offsetting smartphone slowdown — hold.",
    "WMT":   "Walmart+ membership + ad revenue diversifying beyond retail; vibecession tailwind for value shopping — defensive hold.",
    "BRK-B": "Record $325B+ cash hoard — Berkshire positioned for opportunistic acquisitions if recession deepens — ultimate defensive hold.",
    "AMD":   "MI300X gaining AI data center share; EPYC at 25%+ server CPU market share; hold as NVDA complement.",
    "RDDT":  "Reddit early monetization phase; DAU growth solid; speculative position, size is appropriately small — hold.",
    "ALK":   "Travel demand resilient; Alaska-Hawaiian merger integration is the main overhang; hold near current levels.",
    "SNOW":  "Cloud data retention high but growth normalizing; Databricks competition is real — watch next earnings before adding.",
    # ── IPO / Special Holds ───────────────────────────────────────────────────
    "BLSH":  "Bullish Exchange (crypto exchange, not biotech) — 3rd-largest spot exchange by volume ($60B/mo); trading near cost basis; hold until LT Aug 2026.",
    "KLAR":  "Klarna BNPL — down ~50% from your $28 avg cost (72% from IPO high); active securities class action; reassess thesis, don't add before LT Sep 2026.",
    "STUB":  "Hold until LT eligible Sep 2026; monitor quarterly results — insufficient data for deeper thesis.",
    # ── Crypto ─────────────────────────────────────────────────────────────────
    "BTC":   "Institutional ETF inflows raising the cycle floor; post-halving dynamics intact — hold, add selectively if BTC approaches $70K, keep under 5% of portfolio.",
    "XRP":   "SEC case settled Mar 2026, digital commodity status confirmed; CLARITY Act Senate markup (late April) is binary catalyst — hold, don't add ahead of vote.",
}
