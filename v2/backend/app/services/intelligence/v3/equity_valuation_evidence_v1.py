...
This is the first valuation evidence lane. It does NOT produce fair values,
price targets, or synthesized recommendations. It produces an auditable
evidence foundation suitable for future deterministic policy/synthesis gates.
...
Architecture contracts (non-negotiable):
  ...
  - valuation_interpretation_band is UNKNOWN unless defensible from trusted
    deterministic thresholds — at Stage 9E, raw EPS/price are not in scope,
    so band is always UNKNOWN.
"""
...
def build_equity_valuation_evidence_row(
    *,
    ...
    Returns:
        ...
        valuation_interpretation_band=UNKNOWN always at Stage 9E.
